...
const BTN_GROUPS_DEFAULT = [
  { id:'produto',   label:'Produto encontrado',   desc:'Botões após listar produto',    editavel:true,
    btns:[{label:'Adicionar',on:true},{label:'Ver foto',on:true},{label:'Tirar dúvida',on:true}] },
  ...
  { id:'pedido_nao_encontrado', label:'Pedido não encontrado', desc:'Pedido não localizado pelo número ou CPF', editavel:false,
    btns:[{label:'Tentar outro número',on:true},{label:'Informar CPF',on:true}] },
  { id:'multiplos_pedidos', label:'Múltiplos pedidos',  desc:'Cliente tem mais de 1 pedido no cadastro', editavel:false,
    btns:[{label:'Ver todos os pedidos',on:true},{label:'Digitar número',on:true}] },
  { id:'pedido_entregue', label:'Pedido entregue',       desc:'Botões após confirmar entrega',          editavel:true,
    btns:[{label:'Avaliar pedido',on:true},{label:'Devolver produto',on:true},{label:'Nova compra',on:true}] },
  ...
  { id:'pedido_aguardando', label:'Pedido aguardando',   desc:'Pedido sem envio ainda',                editavel:true,
    btns:[{label:'Cancelar pedido',on:true},{label:'Reportar problema',on:true},{label:'Nova compra',on:true}] },
