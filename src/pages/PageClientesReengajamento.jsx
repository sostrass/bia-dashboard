      ...
      <div className="fixed top-0 right-0 bottom-0 w-96 z-50 bg-[var(--bg-2)] border-l border-[var(--sep)] flex flex-col overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[var(--sep)]">
          ...
          <button onClick={onClose} className="w-7 h-7 rounded-lg border border-[var(--sep)] flex items-center justify-center hover:bg-[var(--bg-3)]">
            <svg className="w-3.5 h-3.5 text-[var(--label-3)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
          </button>
        </div>
        ...
        <div className="px-5 py-4 border-t border-[var(--sep)]">
          <button onClick={disparar} disabled={disparando}
            ...
            {disparando
              ? <><svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg> Enviando...</>
              : <><svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg> Enviar reengajamento</>
            }
          </button>
        </div>
      </div>
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-5 py-3 border-b border-[var(--sep)]">
        <div className="flex items-center gap-2 flex-1 px-3 py-2 rounded-xl bg-[var(--bg)] border border-[var(--sep)] focus-within:border-[var(--accent)]">
          <svg className="w-3.5 h-3.5 text-[var(--label-4)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
        ...
        {loading
          ...
          : filtrados.length === 0
            ? <div className="flex flex-col items-center justify-center h-32 gap-2">
                <svg className="w-8 h-8 text-[var(--label-4)] opacity-30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M8 15s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>
      ...
      {loading
        ...
        : produtos.length === 0
          ? <div className="flex flex-col items-center justify-center py-16 gap-3">
              <svg className="w-12 h-12 text-[var(--label-4)] opacity-20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
                ...
                <div key={i} className="rounded-2xl bg-[var(--bg-2)] border border-[var(--sep)] p-4 flex items-center gap-4">
                  ...
                  <button
                    ...
                    {notifando && notifId === p.produto_id
                      ? <svg className="w-3.5 h-3.5 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
                      : <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.5a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2.76h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l.81-.81a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 17z"/></svg>
                    }
                    Notificar clientes
                  </button>
                </div>
