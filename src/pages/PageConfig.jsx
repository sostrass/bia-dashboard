...
const integrations = [
  ...
  { key: 'gemini', name: 'Gemini AI (Google)', desc: 'Motor de inteligência artificial', fields: [{ k: 'GEMINI_API_KEY', l: 'API Key', ph: 'AIzaSy...' }, { k: 'GEMINI_MODEL', l: 'Modelo', ph: 'gemini-2.0-flash' }], color: '#4285F4', doc: 'aistudio.google.com' },
]
